...
2. For each chosen target, run ONE `web_search` for recent telecom news, strategy updates, or executive announcements. Respect the global 10-searches-per-session cap and the 200 ms sequential spacing.
